...
<body>
  ...
  <div class="container">
    ...
    <main>
        ...
        <div class="centrar">
          <button type="submit" name="agregar" class="boton" value="agregar">Agregar Partes</button><a href="<?php echo constant('URL')?>inventario" class="boton margin-lados">Volver</a>
        </div>
